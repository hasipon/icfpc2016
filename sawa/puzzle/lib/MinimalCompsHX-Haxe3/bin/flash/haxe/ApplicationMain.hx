...
class ApplicationMain {
	...
	public static function create ():Void {
		...
		urls.push ("assets/HaxeFlixel.svg");
		types.push (lime.Assets.AssetType.TEXT);
		
		
		urls.push ("PF Ronda Seven");
	...
	public static function start ():Void {
		...
		var hasMain = false;
		var entryPoint = Type.resolveClass ("Minimalcompshx");
...
@:keep class DocumentClass extends Minimalcompshx {}
